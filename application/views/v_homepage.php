...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('asset_home/css/styles.css'); ?>" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
        ...
        <section class="showcase">
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('<?php echo base_url("asset_home/assets/img/bg-showcase-1.jpg"); ?>')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('<?php echo base_url("asset_home/assets/img/bg-showcase-2.jpg"); ?>')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('<?php echo base_url("asset_home/assets/img/bg-showcase-3.jpg"); ?>')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url('asset_home/assets/img/testimonials-1.jpg'); ?>" alt="..." />
                            <h5>Margaret E.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url('asset_home/assets/img/testimonials-2.jpg'); ?>" alt="..." />
                            <h5>Fred S.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="<?php echo base_url('asset_home/assets/img/testimonials-3.jpg'); ?>" alt="..." />
                            <h5>Sarah W.</h5>
